...
#define WaveFont [UIFont boldSystemFontOfSize:26.0f]
#define WaveFillColor [UIColor groupTableViewBackgroundColor] // 填充颜色
#define WaveFrontColor [UIColor colorWithRed:0/255.0 green:190/255.0 blue:255/255.0 alpha:1.0f] // 前面波浪颜色
#define WaveBackColor [UIColor colorWithRed:0/255.0 green:190/255.0 blue:255/255.0 alpha:0.4f] // 后面波浪颜色

@interface WaveView ()

@property (nonatomic, strong) CADisplayLink *displayLink;
@property (nonatomic, assign) CGFloat wave_amplitude; // 振幅a(y = asin(wx + φ) + b)
...
- (void)setProgress:(CGFloat)progress
{
    ...
    _valueLabel.text = [NSString stringWithFormat:@"%d%%", (int)floor(progress * 100)];
...
- (void)drawRect:(CGRect)rect
{
    ...
    // 绘制两个波形图
    [self drawWaveColor:WaveFrontColor offsetx:0 offsety:0];
    [self drawWaveColor:WaveBackColor offsetx:_wave_h_distance offsety:_wave_v_distance];
}
